...
iconinit(void)
{
	background = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x282828FF);

	/* greys are multiples of 0x11111100+0xFF, 14* being palest */
	cols[BACK] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x383838FF^reverse);
	cols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x383838FF^reverse);
	cols[TEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xC8C8C8FF^reverse);
	cols[HTEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xC8C8C8FF);
	if(!reverse) {
		cols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x000000FF);
		titlecol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x303030FF);
		lighttitlecol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x303030FF);
	} else {
		cols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x000000FF);
		titlecol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x303030FF);
		lighttitlecol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x303030FF);
	}
	dholdcol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x555555FF);
	lightholdcol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x555555FF);
	paleholdcol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xC8C8C8FF);
	paletextcol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x666666FF^reverse);
	sizecol = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DRed);
