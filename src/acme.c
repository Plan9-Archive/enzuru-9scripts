...
iconinit(void)
{
	...
	/* Blue */
	tagcols[BACK] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x383838FF);
	tagcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x000000FF);
	tagcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x383838FF);
	tagcols[TEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x888888FF);
	tagcols[HTEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xC8C8C8FF);

	/* Yellow */
	textcols[BACK] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x383838FF);
	textcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x000000FF);
	textcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x383838FF);
	textcols[TEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xC8C8C8FF);
	textcols[HTEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xC8C8C8FF);
	...
	r = insetrect(r, 2);
	tmp = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x282828FF);
	draw(modbutton, r, tmp, nil, ZP);
	freeimage(tmp);

	r = button->r;
	colbutton = allocimage(display, r, screen->chan, 0, 0x282828FF);
